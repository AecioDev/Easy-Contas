...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Por exemplo, enviando uma requisição para sua API
    console.log("Cadastro:", { nome, telefone, email, senha });
    // Após cadastro bem-sucedido, redirecione para a página de login
    router.push("/login");
  };
